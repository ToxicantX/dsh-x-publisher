...
The settings page displays the Callback URL generated by the current DSH Web Server. Click **Copy** to copy the exact value, or click **Open X Developer Console** to configure the X application.
